class SudokuField
  ...
  def initialize(default = nil)
    ...
    self.send(default.to_s) unless default.nil?
  end
  ...
  def evil
    ...
    @field[0] = [ 0, 0, 0, 1, 0, 0, 2, 9, 5 ]
    @field[1] = [ 8, 0, 1, 2, 0, 4, 0, 0, 0 ]
    @field[2] = [ 0, 0, 0, 0, 9, 0, 0, 0, 0 ]
    @field[3] = [ 0, 2, 0, 0, 0, 9, 8, 0, 0 ]
    @field[4] = [ 1, 0, 0, 0, 0, 0, 0, 0, 3 ]
    @field[5] = [ 0, 0, 3, 6, 0, 0, 0, 5, 0 ]
    @field[6] = [ 0, 0, 0, 0, 3, 0, 0, 0, 0 ]
    @field[7] = [ 0, 0, 0, 5, 0, 1, 7, 0, 8 ]
    @field[8] = [ 5, 7, 4, 0, 0, 6, 0, 0, 0 ]

    true
  end

  def unsolved
    @field[0] = [ 8, 5, 0, 0, 7, 0, 4, 0, 0 ]
    @field[1] = [ 0, 7, 0, 2, 0, 0, 0, 0, 0 ]
    @field[2] = [ 0, 6, 0, 0, 0, 9, 0, 0, 0 ]
    @field[3] = [ 9, 0, 0, 0, 6, 0, 0, 0, 0 ]
    @field[4] = [ 3, 0, 8, 0, 0, 0, 7, 0, 1 ]
    @field[5] = [ 0, 0, 0, 0, 2, 0, 0, 0, 5 ]
    @field[6] = [ 0, 0, 0, 8, 0, 0, 0, 2, 0 ]
    @field[7] = [ 0, 0, 0, 0, 0, 1, 0, 9, 0 ]
    @field[8] = [ 0, 0, 7, 0, 3, 0, 0, 5, 8 ]
    true
  end
